...
- [Pet revival system](pet-revival.md) — 10 Stars, max 3 revivals per pet, 3-day window; payload pet_revive_{uid}_{pet_id}; revival_count/max_revivals columns (v5)
...
- [Nav redesign](nav-redesign.md) — 7→5 tabs; quests→casino inner tab, donations split: subscriptions→shop, referrals→giveaway; inner sub-tab bars + stats pill tabs
